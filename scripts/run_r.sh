...
SCRIPT_PATH="/home/hejunhui/R/ABMRS/scripts/surface_fitting_appendix.r"  # Path to the R script

# Adjust these if you want a different number of replicates per array task
REPS_PER_TASK=${REPS_PER_TASK:-5}

echo "Starting surface_fitting_appendix task ${SLURM_ARRAY_TASK_ID} with ${REPS_PER_TASK} replicates"

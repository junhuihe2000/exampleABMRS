...
ebars_1 = ebars(x_train, ys[i,1,], gamma = 0.5, times = 1, intercept = TRUE)
ebars_1$rjmcmc(burns=5000,steps=5000)
ys[i,2,] = rowMeans(ebars_1$predict(x_train))

# EBARS with gamma = 1
ebars_2 = ebars(x_train, ys[i,1,], gamma = 1, times = 3, intercept = TRUE)
ebars_2$rjmcmc(burns=5000,steps=5000)
ys[i,3,] = rowMeans(ebars_2$predict(x_train))

# EBARS with gamma = 1.5
ebars_3 = ebars(x_train, ys[i,1,], gamma = 1.5, times = 3, intercept = TRUE)
